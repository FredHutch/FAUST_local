...
RUN R -e "devtools::install_github('FredHutch/scampDev', auth_token='[REDACTED]')"
RUN R -e "devtools::install_github('FredHutch/faust', ref='nextflow', auth_token='[REDACTED]')"